...
def do_math_row_major(matrix: list[list[float]]):
    """
...
def divide_by_two_row_major(matrix: list[list[float]]):
    """
...
def divide_by_two_column_major(matrix: list[list[float]]):
    """
...
def compare_matrix_operations():
    ...
    report_performance(runs, divide_by_two_row_major, [[float(i) for i in range(1, size)] for _ in range(size)])
    report_performance(runs, divide_by_two_column_major, [[float(i) for i in range(1, size)] for _ in range(size)])
