...
class TestMain(unittest.TestCase):
    ...
    @patch('gc_content.gc_content.read_sequences_from_file')
    @patch('gc_content.gc_content.calculate_gc_content')
    def test_main(self, mock_calculate, mock_read, mock_print, mock_parse_args):
    ...
    @patch('gc_content.gc_content.read_sequences_from_file')
    @patch('gc_content.gc_content.calculate_gc_content')
    def test_main_empty(self, mock_calculate, mock_read, mock_print, mock_parse_args):
        # Set up mock arguments
        mock_parse_args.return_value.file_path = "dummy.fasta"
